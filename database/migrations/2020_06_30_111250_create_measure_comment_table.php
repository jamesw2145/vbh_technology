...
class CreateMeasureCommentTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('measure_comment', function (Blueprint $table) {
            $table->increments('comment_uid');
    ...
    {
        Schema::dropIfExists('measure_comment');
    }
}
